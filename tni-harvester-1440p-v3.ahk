...
global CONFIG := {
    ...
    ; Screen coordinates for 2560x1440 fullscreen
    ; F12 Window Spy verified - Nov 2024
    coords: {
        ; Main menu - "Start a new game" button center
        startNewGame: { x: 1035, y: 410 },
        
        ; New game setup screen - TABS (F12 verified)
        scenariosTab: { x: 397, y: 452 },     ; Scenarios tab - click to switch from Tutorials
        
        ; New game setup screen - after clicking Scenarios (F12 verified)
        seedField: { x: 618, y: 784 },        ; World seed text field center
        playSolo: { x: 326, y: 1084 },        ; Play Solo button center
        
        ; In-game tablet
        secretariatIcon: { x: 499, y: 767 },  ; The Secretariat app icon
        proposalsTab: { x: 273, y: 165 },     ; Proposals tab in Secretariat
        
        ; Escape menu
        quitToMainMenu: { x: 385, y: 648 },   ; "Quit to main menu" button
        
        ; Scroll - click bottom of scrollbar to scroll down
        scrollbarBottom: { x: 653, y: 1187 }
    },
    
    ; OCR capture regions
    captureRegions: {
        full: { x1: 50, y1: 230, x2: 645, y2: 1200 },
        top: { x1: 50, y1: 230, x2: 645, y2: 715 },
        bottom: { x1: 50, y1: 500, x2: 645, y2: 1200 }
    },
...
ShowStatus(message) {
    ...
    ; Position: x=1280 (center of 2560), y=50 (near top)
    ToolTip(message, 1280, 50)
}
